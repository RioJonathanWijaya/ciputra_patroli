...
class _StartPatroliState extends State<StartPatroli> {
  ...
  void didChangeDependencies() {
    ...
    patroliVM = Provider.of<PatroliViewModel>(context, listen: false);

    final args =
        ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>;
    penugasanVM = args['penugasanVM'];
    penugasan = args['penugasan'];
    patroli = args['patroli'];
    loginVM = args['loginVM'];
  }
  ...
  void submitForm() {
    ...
    if (patroliVM.currentPatroli == null) {
      ...
      patroliVM.endPatroli(catatanPatroli: _textController.toString());
    }
