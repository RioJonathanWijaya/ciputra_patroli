            ...
            body: Consumer<PenugasanPatroliViewModel>(
              builder: (context, penugasanVM, child) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  if (penugasanVM.penugasanList.isEmpty &&
                      !penugasanVM.isLoading) {
                    penugasanVM.getPenugasanData();
                  }
                });

                if (penugasanVM.isLoading) {
                  return const Center(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: penugasanVM.penugasanList.isEmpty
                                  ? Center(
                                      child: Column(
                                        mainAxisAlignment:
                                  ...
                                  : RefreshIndicator(
                                      color: const Color(0xFF1C3A6B),
                                      onRefresh: () async =>
                                          await penugasanVM.getPenugasanData(),
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          final penugasan = Penugasan.fromMap(
                                              penugasanVM.penugasanList[index]);
                                          return JadwalCard(
                                            penugasan: penugasan,
                                            onTap: () {
                                              final penugasan =
                                                  Penugasan.fromMap(penugasanVM
                                                      .penugasanList[index]);
